...
- When the user asks to remember something, continue naturally; extraction hooks persist decisions/facts/tasks/questions from transcripts, and reset/new-session boundaries persist `session_summary` continuity artifacts.
...
### Retrieval Order
1. Use `MEMORY.md` + injected Reclaw previous-session summary context already in prompt.
